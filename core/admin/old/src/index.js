...
Vue.component('menubar', require('./js/layouts/LayoutMenubar.vue').default);
Vue.component('Home', require('./js/components/Home.vue').default);
Vue.component('about', require('./js/components/about.vue').default);
Vue.component('messaging', require('./js/components/messaging.vue').default);
Vue.component('profile', require('./js/components/profile.vue').default);
Vue.component('checkers', require('./js/components/checkers.vue').default);
Vue.component('chess', require('./js/components/chess.vue').default);
